...
## Performance charts
Charts are generated by `benchmark.py` into the `charts/` directory when you run the benchmark locally. The README references those images so they render once you add them to the repo.

### Throughput (higher is better)
![Throughput chart](charts/throughput.png)

### Mean render time (lower is better)
![Mean render time chart](charts/mean_time.png)
...
- `charts/`: generated PNG charts (add these locally to render the images above).
